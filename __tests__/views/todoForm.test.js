...
test('selectCreator in views/todoForm', () => {
  ...
  const expected = '<select id="categoriesSelect"><option value="undefined"></option></select>';
  expect(actual.outerHTML).toEqual(expected);
});
