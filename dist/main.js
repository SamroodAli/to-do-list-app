...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _newTodoForm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newTodoForm.js */ \"./src/newTodoForm.js\");\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n/* harmony import */ var _todoCard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todoCard */ \"./src/todoCard.js\");\n/* harmony import */ var _category_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./category.js */ \"./src/category.js\");\n/* harmony import */ var _newCategoryForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./newCategoryForm */ \"./src/newCategoryForm.js\");\n\n\n\n\n\n\nconst content = document.getElementById(\"content\");\n\nconst project1 = new _category_js__WEBPACK_IMPORTED_MODULE_3__.default(\"Project 1\");\nconst project2 = new _category_js__WEBPACK_IMPORTED_MODULE_3__.default(\"Project 2\");\nconst project3 = new _category_js__WEBPACK_IMPORTED_MODULE_3__.default(\"Project 3\");\n\nconst categories = [];\n\nconst form = (0,_newTodoForm_js__WEBPACK_IMPORTED_MODULE_0__.default)(categories);\nconst categoryForm = (0,_newCategoryForm__WEBPACK_IMPORTED_MODULE_4__.default)();\nconst todos = [];\n\nfunction submit(form, event) {\n  event.preventDefault();\n  const [title, description, date, priority, option] = Array.from(\n    form.elements\n  ).map((ele) => ele.value);\n  const newTodo = new _todo_js__WEBPACK_IMPORTED_MODULE_1__.default(\n    title,\n    description,\n    date,\n    priority,\n    categories[option]\n  );\n  todos.push(newTodo);\n  refresh();\n}\n\nfunction newCategory(form, event) {\n  event.preventDefault();\n  const [name] = Array.from(form.elements).map((ele) => ele.value);\n  const newCategory = new _category_js__WEBPACK_IMPORTED_MODULE_3__.default(name);\n  categories.push(newCategory);\n  refresh();\n}\n\ncategoryForm.addEventListener(\"submit\", (event) =>\n  newCategory(categoryForm, event)\n);\n\nfunction newForm(categories) {\n  const form = (0,_newTodoForm_js__WEBPACK_IMPORTED_MODULE_0__.default)(categories);\n  form.addEventListener(\"submit\", (event) => submit(form, event));\n  return form;\n}\n\nfunction refresh() {\n  content.innerHTML = \"\";\n  content.append(\n    newForm(categories),\n    categoryForm,\n    ...todos.map((todo) => (0,_todoCard__WEBPACK_IMPORTED_MODULE_2__.default)(todo))\n  );\n}\ncontent.append(newForm(categories), categoryForm);\n\n\n//# sourceURL=webpack://restuarant-page/./src/index.js?");
