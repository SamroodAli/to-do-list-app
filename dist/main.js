...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"newTodoForm\": () => (/* binding */ newTodoForm),\n/* harmony export */   \"updateTodoForm\": () => (/* binding */ updateTodoForm)\n/* harmony export */ });\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n/* harmony import */ var _formTags_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formTags.js */ \"./src/formTags.js\");\n\n\n\n\nconst optionsCreator = (categories) => {\n  return categories.map((category, idx) =>\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.option)(category.name, \"\", { value: idx })\n  );\n};\n\nconst selectCreator = (categories) => {\n  return (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.select)(optionsCreator(categories), \"\", { id: \"categoriesSelect\" });\n};\n\nconst todoForm = (categories = []) => {\n  return (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.form)([\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.textInput)(\"Enter title\", \"\", { name: \"title\" }),\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.textArea)(\"\", \"\", {\n      placeholder: \"Enter description for the todo\",\n      required: \"\",\n      name: \"description\",\n    }),\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.labelFor)(\"Enter due date\", \"date\"),\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.dateInput)(\"Enter due date\", \"\", { id: \"date\", name: \"date\" }),\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.labelFor)(\"Enter priority\", \"todo-priority\"),\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.numberInput)(\"\", \"\", { min: 0, max: 10, id: \"priority\", name: \"priority\" }),\n    selectCreator(categories),\n    (0,_formTags_js__WEBPACK_IMPORTED_MODULE_1__.submitButton)(),\n  ]);\n};\n\nfunction onFormSubmit(form, event, categories) {\n  event.preventDefault();\n  const [title, description, date, priority, option] = Array.from(\n    form.elements\n  ).map((ele) => ele.value);\n\n  const category = categories[option];\n  const newTodo = new _todo_js__WEBPACK_IMPORTED_MODULE_0__.default(title, description, date, priority, category);\n  category.addTodo(newTodo);\n}\n\nconst newTodoForm = (categories) => {\n  const form = todoForm(categories);\n  form.addEventListener(\"submit\", (event) =>\n    onFormSubmit(form, event, categories)\n  );\n  return form;\n};\n\nconst updateTodoForm = (categories) => {\n  const select = document.getElementById(\"categoriesSelect\");\n  select.innerHTML = \"\";\n  select.append(...optionsCreator(categories));\n};\n\n\n//# sourceURL=webpack://restuarant-page/./src/newTodoForm.js?");
